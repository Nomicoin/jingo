...
function extractTags(text) {
  ...
  text = text.replace(/\|/g, " | "); // Next block of code gets confused
                                     // by markdown table pipes ("|")
                                     // adjescent to double bracket link tag ("[[").
                                     // ex: | column 1 | column 2 |[[link]]|
                                     // Inserting spaces allows proper link parsing.
