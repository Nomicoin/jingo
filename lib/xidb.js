...
Xidb.prototype.getMetadata = function(xid, cid) {
  ...
  metadata.navigation.age = moment(metadata.base.timestamp).fromNow();;
...
Xidb.prototype.savePage = function(user, xlink, page, cb) {
  var command = "python savePage.py -a " + user.email + " -x " + xlink;
...
Xidb.prototype.addComment = function(user, xlink, comment, cb) {
  var command = "python addComment.py -a " + user.email + " -x " + xlink;
...
Xidb.prototype.addVote = function(user, xlink, body, cb) {
  var command = "python addVote.py -a " + user.email + " -x " + xlink + " --vote " + body.vote;
...
Xidb.prototype.newAsset = function(user, kind, title, cb) {
  var command = "python newAsset.py -a \"" + user.email + "\" -k \"" + kind + "\" -t \"" + title + "\"";
...
Xidb.prototype.uploadImage = function(user, upload, name, field, asset, cb) {
  var command = "python uploadImage.py -a " + user.email
